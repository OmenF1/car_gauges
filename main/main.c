...
#include "esp_now_lib/esp_now_lib.h"
#include "wifi_lib/wifi_lib.c"

// [DEFAULT] ESP32 Board MAC Address: d8:3b:da:4b:d4:b8
...
#define LEDC_DUTY               (1600)    // Set duty to 50%. (2 ** 13) * 50% = 4096
